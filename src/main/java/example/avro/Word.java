...
public class Word extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4695151282450000792L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Word\",\"namespace\":\"example.avro\",\"fields\":[{\"name\":\"word\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"count\",\"type\":[\"int\",\"null\"]}]}");
   ...
   */
  public Word(java.lang.String word, java.lang.Integer count) {
    this.word = word;
    this.count = count;
  }
   ...
   */
  public static example.avro.Word.Builder newBuilder() {
    return new example.avro.Word.Builder();
  }
   ...
   * @return A new Word RecordBuilder
   */
  public static example.avro.Word.Builder newBuilder(example.avro.Word.Builder other) {
    return new example.avro.Word.Builder(other);
  }
   ...
   * @return A new Word RecordBuilder
   */
  public static example.avro.Word.Builder newBuilder(example.avro.Word other) {
    return new example.avro.Word.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Word>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(example.avro.Word.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(example.avro.Word other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.word)) {
        this.word = data().deepCopy(fields()[0].schema(), other.word);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro.Word.Builder setWord(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro.Word.Builder clearWord() {
      word = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro.Word.Builder setCount(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro.Word.Builder clearCount() {
      count = null;
